...
public class librarybookissueandreturn  {
    public static void main(String[] args) {
        Library library = new Library();

        // Adding sample books to the library
        library.addBook(new Book(1, "Rich Dad Poor Dad", "Robert Kiyosaki"));
        library.addBook(new Book(2, "The Millionaire Mindset", "Gerry Robert"));
